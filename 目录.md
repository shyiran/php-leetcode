...
6. Z 字形变换---------------------------------------------------------leetcode-0006-zigzag-conversion.php
...
32. 最长有效括号-----
33. 搜索旋转排序数组-----
34. 在排序数组中查找元素的第一个和最后一个位置(中等)-leetcode-34-find-first-and-last-position-of-element-in-sorted-array.php
35. 搜索插入位置(简单)---------------------------------------leetcode-035-search-insert-position.php
36. 有效的数独(中等)-----leetcode-36-valid-sudoku.php
37. 解数独-----
38. 外观数列-----
39. 组合总和-----
40. 组合总和 II-----
...
43. 字符串相乘(中等)-----leetcode-43-multiply-strings.php
44. 通配符匹配-----
45. 跳跃游戏 II-----
46. 全排列-----
47. 全排列 II-----
...
583. 两个字符串的删除操作(中等)-------------leetcode-583-delete-operation-for-two-strings.php
